...
pc4.test = pc4[-training,-14]
pc4.test.results = pc4[-training,14]
...
pc4.tree <- tree(Opioids ~ ., data=pc4[training,], mindev=0.001)
...
pc4.tree.proportions <- predict(pc4.tree, pc4[-training, -6])
...
sum(pc4.tree.classifications == pc4.test.results) / nrow(pc4[-training,])
